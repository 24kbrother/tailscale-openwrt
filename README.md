...
全新安装
```
wget -O- https://github.com/24kbrother/tailscale-openwrt/blob/chinese_mainland/install.sh | sh
```
...
```
wget -O- https://github.com/24kbrother/tailscale-openwrt/blob/chinese_mainland/uninstall.sh | sh
```
------------
## 0x02 升级
- 升级tailscale
...
```
rm -rf /tmp/tailscale* && wget -O- https://github.com/24kbrother/tailscale-openwrt/blob/chinese_mainland/install.sh | sh && reboot
```
------------
